...
目录：| [索引](#索引) | [获取](#获取) | [加成计算](#加成计算) | [装配](#装配) |
...
- **普通试炼**
找到试炼刷怪笼并触发普通试炼，将全部生成的怪物击杀后，配件将从试炼刷怪笼喷出(同原版流程)。
大概率出现白色、绿色配件，小概率出现蓝色配件，极小概率出现紫色配件，不会出现金色配件。
- **不详试炼**
找到试炼刷怪笼，使用不详之瓶获取试炼之兆并触发不详试炼，将全部生成的怪物击杀后，配件将从试炼刷怪笼喷出(同原版流程)。如果已有试炼之兆或不祥之兆则不需要使用不祥之瓶。
...
- **装配**
打开背包时，将配件移到对应的装备上并右键。

- **替换**
在装备有配件槽时若尝试装备已装备的同名配件，则原装备的配件将被现装备的配件替换。

- **卸下**
打开背包，对装备右键即可打开配件界面。点击需要卸下的配件并确认，即可卸下该配件。
> 卸下的配件将直接销毁而不返还，所以请谨慎装配配件。
{.is-warning}
