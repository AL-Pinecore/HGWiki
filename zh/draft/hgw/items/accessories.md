...
本页是向导页面，旨在帮助您找到[乐魂战](/quick-start#乐魂战)中的某个配件并浏览其信息。
...
- 近战武器 配件
**通用**: | [合金镀层](/zh/hgw/items/accessories/metal_coating) |
**剑**: | [钢化锋刃](/zh/hgw/items/accessories/tempered_blade) | [共振刀刃](/zh/hgw/items/accessories/resonant_blade) | [气动剑柄](/zh/hgw/items/accessories/aerodynamic_hilt) |
**斧**: 暂无
**镐**: 暂无
**锹**: 暂无
**动力匕首**: | [末影锚](/zh/hgw/items/accessories/ender_anchor) | [偏心轮机构](/zh/hgw/items/accessories/eccentric_wheel) | [气动机架](/zh/hgw/items/accessories/aerodynamic_mechanism) | [纤维绳索](/zh/hgw/items/accessories/fiber_rope) |
**矛**: 暂无
...
配件共有三种获取方式，分别为
- **准备阶段自选配件**
准备阶段，在配件选择界面中的54个所有人相同的随机配件中选择5个配件。
大概率出现白色、绿色配件，小概率出现蓝色配件，极小概率出现紫色配件，不会出现金色配件。
- **普通试炼**
在试炼岛找到试炼刷怪笼并触发普通试炼，将全部生成的怪物击杀后，配件将从试炼刷怪笼喷出(同原版流程)。
大概率出现白色、绿色配件，小概率出现蓝色配件，极小概率出现紫色配件，不会出现金色配件。
- **不详试炼**
在试炼岛找到试炼刷怪笼，使用不详之瓶获取试炼之兆并触发不详试炼，将全部生成的怪物击杀后，配件将从试炼刷怪笼喷出(同原版流程)。如果已有试炼之兆或不祥之兆则不需要使用不祥之瓶。
大概率出现蓝色配件，中等概率出现紫色配件，极小概率出现金色配件，不会出现白色、绿色配件
...
- 某正面词条: +[0roll值,满roll值]单位
- 某负面词条: -[0roll值,满roll值]单位
- 某中性词条或固定词条
> 对于正面词条,0roll值总是小于满roll值
> 对于负面词条,0roll值总是大于满roll值
{.is-info}


**贴图:**

<配件白色贴图><配件绿色贴图><配件蓝色贴图><配件紫色贴图><配件金色贴图>
*若该配件无对应品质则无对应贴图*
