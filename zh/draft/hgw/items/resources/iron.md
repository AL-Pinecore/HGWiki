...
- 使用三阶的[镐](/hgw/items/equipments#镐)挖掘浅层铁矿石或深层铁矿石将直接获得一至两个铁锭 :iron_ingot:  
  使用三阶的[镐](/hgw/items/equipments#镐)挖掘粗铁块将会直接固定获得四个铁锭 :iron_ingot: 
